...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/shawnsong/Development/WizardsOfOCR/api/venv/python'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/shawnsong/Development/WizardsOfOCR/api/venv/python/bin/deactivate.nu'
